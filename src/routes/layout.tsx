...
export const useTranslations = routeLoader$(({ request, url }) => {
  ...
  const t = {
    ...
    es: {
      ...
      hero_subtitle: "Full Stack Developer",
      hero_desc:
        "Experiencia construyendo aplicaciones web y servicios serverless con React, Node.js, TypeScript y Next.js, trabajando con bases de datos SQL y NoSQL, arquitectura limpia, documentación clara y colaboración en equipos ágiles.",
      ...
      experience_1_desc:
        "Diseño y desarrollo de proyectos escalables para clientes y ONGs asociadas, implementando REST APIs, arquitecturas serverless, esquemas de bases de datos e interfaces frontend responsivas.\nDiseño e implementación de la aplicación full-stack de la organización para la gestión de cursos y estudiantes.\nMantenimiento e implementación de nuevos requerimientos en la web institucional.\nMigración de bundler a Vite, hosting a Vercel y proveedor de DNS a Cloudflare.\nDesarrollo de Workers para observabilidad de configuraciones DNS y nameservers.\nImplementación de routing de correos personalizados usando SMTP y POP3.\nAutomatización de despliegues, configuración del firewall y observabilidad.\nDocumentación técnica de proyectos, arquitectura interna, configuraciones DNS, despliegues y políticas de seguridad.",
